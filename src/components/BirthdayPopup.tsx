          ...
          <div className="text-center animate-fade-in">
            ...
            <div className="flex gap-4 justify-center">
              ...
              >
                <div>No 😢</div>
                <div
                  className={`text-sm mt-2 transition-all duration-500 overflow-hidden ${
                    step === 'question1' ? 'max-h-20 opacity-100' : 'max-h-0 opacity-0'
                  }`}
                >
          ...
          <div className="text-center animate-fade-in">
            ...
            <div className="flex gap-4 justify-center">
              ...
              >
                ...
                <div
                  className={`text-sm mt-2 transition-all duration-500 overflow-hidden ${
                    step === 'question2' ? 'max-h-20 opacity-100' : 'max-h-0 opacity-0'
                  }`}
                >
                  My bad 🤭
                </div>
